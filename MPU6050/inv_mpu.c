...
#define q30 1073741824.0f //2 to the 30th power
#define SlaveAddress 0x68 //MPU6050 address
int fd = -1;              //i2c file handler
...
{
    u8 res = 0;
    if ((fd = wiringPiI2CSetup(SlaveAddress)) < 0)
    {
...
//pitch:    preci:0.1° range:-90.0° <---> +90.0°
//roll:     preci:0.1° range:-180.0°<---> +180.0°
//yaw:      preci:0.1° range:-180.0°<---> +180.0°
...
u8 mpu_dmp_get_data(float *pitch, float *roll, float *yaw)
{
    ...
    {
        q0 = quat[0] / q30; //q30 form to float
        q1 = quat[1] / q30;
        q2 = quat[2] / q30;
        q3 = quat[3] / q30;
